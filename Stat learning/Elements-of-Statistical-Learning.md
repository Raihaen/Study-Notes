...
$= \text{E}[f(x_0) ^2 +\hat f(x_0)^2 - 2 f(x_0) \cdot \hat f(x_0)] = \left \text{E}(\hat f(x_0) ^2) - [\text{E}(\hat f(x_0)]^2 \right + \left [\text{E}(\hat f(x_0)]^2 + \text{E}[f(x_0) ^2 - 2 f(x_0) \cdot \hat f(x_0)] \right $ \ 
