...
- We say that $X_n$ converges in distribution to $X$ if : $ \lim_{n \rightarrow \inf} CDF_n(t) \rightarrow CDF(t) $ for each point $t$ at which $CDF$ is continious... $CDF_n$ being the Cumulative density function of $X_n$ and $CDF$ that of $X$.
